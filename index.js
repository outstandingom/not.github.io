...
async function openBookingPanel(salonId) {
    ...
    // Pre-fill user details and salon UPI ID
    document.getElementById('customerName').value = currentUser.full_name || '';
    document.getElementById('customerPhone').value = currentUser.phone || '';
    document.getElementById('customerEmail').value = currentUser.email || '';
    document.getElementById('upi_id').value = currentSalon.upi_id || '';
            ...
            .insert([
                {
                    ...
                    salon_upi_id: currentSalon.upi_id || null // Store salon UPI ID with booking
                }
            ])
            .select();
